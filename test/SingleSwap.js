...
describe("SingleSwapToken", () => {
  ...
  before(async () => {
    ...
    const ISwapRouter = await ethers.getContractAt("ISwapRouter");
    const swapRouter = await ISwapRouter.deploy();
    await swapRouter.deployed();
    console.log("Working");
    const SingleSwapToken = await ethers.getContractFactory("SingleSwapToken");
    singleSwapToken = await SingleSwapToken.deploy(swapRouter.address);
